...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // Создаём объявления
        Advertisement bookAd1 = new Advertisement(Collections.singleton(books), "Путь Ruby", "", "");
        Advertisement bookAd2 = new Advertisement(Collections.singleton(books), "Python. К вершинам мастерства", "", "");
