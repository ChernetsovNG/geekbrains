...
var articleBody = "<div class='post_section'>" + "<h2><a class='article__title' href='' ></a></h2>" +
    "<strong>Дата: </span></strong><span class='article__date'></span>|<strong>Автор: </strong><span class='article__author'></span>"
